...
$kova=@{}
# ⭐ 25.09.2026 DERS DUZELTMESI (Cem "yanlis dersteki sorulari duzelt"). Ders etiketten cozulur; parti yanlis dersin
#   etiketiyle basilmissa soru yanlis sayfaya dusuyordu (olculdu: supheli 164 sorunun metni okundu -> 84'u yanlis
#   derste; en buyugu Ticaret sayfasinda 23 Borclar, Maliyet sayfasinda 20 Finansal Muhasebe sorusu).
#   veri/sinav/sgs-ders-duzelt.json: "<etiket>/<kp-NN>" -> ders. YALNIZ durum=uygula olan kayit uygulanir
#   ('bekle' = tasima bugun cevap dagilimi (circir) kapisini dusurur). Parti dosyalarina dokunulmaz.
#   Hedef ders DERS_TABLO'da yoksa DUR (yanlis yazilmis ders adi sayfa acmasin).
