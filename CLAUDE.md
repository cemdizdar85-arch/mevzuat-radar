...
**Yeni/değişen betik İLK KEZ çalıştırılmadan önce:** `powershell -NoProfile -File arac/tuzak-nobetcisi.ps1 -Yol <dosya>` — BULGU varsa önce düzelt (24.09: K6 kuralı `git … 2>$null`'ın EAP=Stop altında betiği öldürdüğünü YAZIYORDU; yeni prova betiği nöbetçiden geçirilmeden koşturuldu ve 1.943 dosyalık prova yarıda düştü. Kural vardı, sıra yoktu).
...
- ⛔⭐⭐ **SORU BASIM PLANI KAPSAMA TABLOSUNDAN KURULUR — ELDEN PLAN YOK** (22.09.2026, Cem: *"exceli yap ve ona göre soru çıkaralım · ben böyle biliyordum, bunu kural olarak yazalım"*).
  ...
  **Kural — bu sıra atlanmaz:**
  ...
  0a. ⭐ **DERS TABANI 350 + DALGADA DERS PAYI** (Cem 23.09.2026, "1.2.3 üçünü de yap"). Sıklık ağırlığı 4.000'in %49'unu
     Finansal Muhasebe'ye veriyordu — ölçüldü: çıkmış analizinde FM sınavı başına ~39 "soru" (her yevmiye kaydı), öteki
