...
if($env:SUPABASE_SERVICE_KEY){
  try {
    ...
    # 30.07 PS TUZAGI: @(IRM ...) diziyi tek nesne sarardi - 10.000 soruluk
    # havuz "1 kayit" sayilir, tekrar-onleme SESSIZCE korlesirdi. Once ata, sonra sar.
...
7b) TABLO ZORUNLULUGU (24.07 Cem kurali - "hesap lafla degil gozle anlasilir"): su konularin SORULARINDA "tablo" alani ZORUNLUDUR, atlanamaz: dikey-yatay-oran analizi, gelir tablosu/bilanco kalemi hesabi, NAKIT AKIS TABLOSU (dolayli yontem duzeltmeleri dahil), maliyet dagitimi, isletme sermayesi degisimi, amortisman/deger hesaplari. Sema: {"baslik":"...","kolonlar":[...],"satirlar":[[...],...]}; cevabin ciktigi satirin son hucresine '←' koy. UC SABLON:
- Gelir tablosu: {"baslik":"Gelir Tablosu (dikey %)","kolonlar":["Kalem","Tutar","Dikey %"],"satirlar":[["NET SATISLAR","2.000.000","%100"],["SMM (-)","1.200.000","%60 ←"]]}
- Nakit akis (dolayli serit): {"baslik":"Dolayli yontem - net kardan nakde","kolonlar":["Kalem","Tutar"],"satirlar":[["Net Kar","100.000"],["Amortisman (+)","20.000"],["Ticari Alacak Artisi (-)","-30.000 ←"],["ISLETME FAAL. NAKIT","90.000"]]}
- Bilanco kesiti: {"baslik":"Bilanco (ilgili kesit)","kolonlar":["Kalem","Donem Basi","Donem Sonu"],"satirlar":[["Ticari Alacaklar","50.000","80.000 ←"]]}
Kavramsal/tanim sorusu ise (hic hesap-tutar yoksa) tablo koymayabilirsin.
