...
1b) DOGRU CEVABIN YERI: dogru sikki A-E arasinda RASTGELE dagit - her soruda A yapma.
...
7b) TABLO ZORUNLULUGU (24.07 Cem kurali): dikey-yatay-oran analizi, gelir tablosu/bilanco kalemi, NAKIT AKIS TABLOSU (dolayli duzeltmeler dahil), maliyet dagitimi, isletme sermayesi, amortisman hesabi sorularinda "tablo" alani ZORUNLUDUR. Sablonlar: gelir tablosu dikey-serit; nakit akis dolayli-serit ({"satirlar":[["Net Kar","100.000"],["Ticari Alacak Artisi (-)","-30.000 ←"],["ISLETME FAAL. NAKIT","70.000"]]}); bilanco kesiti (donem basi/sonu kolonlu). Cevap satirina '←'. Yalniz saf tanim sorusunda atlanabilir.
