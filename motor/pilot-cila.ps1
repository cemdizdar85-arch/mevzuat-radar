...
3. HESAPLI soruda her yanlis sikkin gerekcesi O SIKKIN RAKAMINI TURETMELI ("30.000 yazan ogrenci amortismani dusmayi unutmustur: 50.000-20.000=30.000"). Rakami turetilemeyen celdirici icin acikca "Bu deger sorudaki verilerden turetilemez; rastgele celdiricidir" yaz - UYDURMA turetim YASAK.
...
{"aciklama":{"A":"...","B":"...","C":"...","D":"...","E":"..."},"hap":"...","sinav_taktigi":"...","dayanak":"...","notlandirici":"...","cozum_tablo":{"basliklar":[],"satirlar":[]},"akis":[],"supheli_cevap":false,"supheli_not":""}
