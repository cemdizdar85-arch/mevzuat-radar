...
# ASGARI SAYI KAPISI (19.08): esik altinda dosya YAZILMAZ (bugun 105, esik ~%57).
if($kodlar.Count -lt 60){
  Write-Host ("KIRMIZI: yalniz " + $kodlar.Count + " kod (esik 60) - gtip-nihai.json YAZILMADI") -ForegroundColor Red
  exit 1
}
