...
$etiketAdaySay=@{}; foreach($e in $etiket.Keys){ $etiketAdaySay[(Katla2 $etiket[$e].ad)]=$etiketAday[$e].Count }   # Excel doldurucu için: pencere etiketi (ASCII) -> kök eşleşmeli aday sayısı
