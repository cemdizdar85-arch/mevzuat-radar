...
# ASGARI SAYI KAPISI (19.08): esik altinda dosya YAZILMAZ (bugun 569, esik ~%70).
if($cikti.Count -lt 400){
  Write-Host ("KIRMIZI: yalniz " + $cikti.Count + " kod (esik 400) - gtip-balik.json YAZILMADI") -ForegroundColor Red
  exit 1
}
