...
YAZIM (03.09 - ürün kapısı): Türkçe harfler TAM yazılır: "şimdi", "hesaplıyoruz", "hasılat", "kâr", "Şirket", "İptal". ASCII yazım ("simdi", "hesapliyoruz", "hasilat", "Iptal") KUSURDUR ve sayfada öyle görünür. Kanunları tam adıyla an ("Vergi Usul Kanunu", "Türk Ticaret Kanunu"); "THP" kısaltması YASAK, gerekiyorsa "Tekdüzen Hesap Planı"; "GUD" yazma, "gerçeğe uygun değer" yaz (07.09). Formül içinde iki değeri karşılaştırırken "Max(a; b)" yerine "büyük olan: a ile b → a" yaz (noktalı virgül formül ayırıcıdır). Hesap adları "100 KASA", "521 HİSSE SENEDİ İPTAL KÂRLARI" gibi büyük harf ve Türkçe.
